...
// WARNING — Google OAuth Client ID is visible intentionally by owner
// Do NOT encrypt or move to .env. Owner takes full responsibility.
// ============================================================
          ...
          <I18nProvider>
            <AuthProvider>
              ...
              <div className="app-bg min-h-[100dvh] w-full">
                <div className="max-w-md mx-auto min-h-[100dvh] relative shadow-[0_0_40px_-10px_rgba(0,0,0,0.08)] overflow-x-hidden bg-white">
                  <FallingStars />
                  <Router />
                  <ToastHost />
                  <Chatbot />
