    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <div
            ref={scrollRef}
            className="flex-1 overflow-y-auto p-3 space-y-2 text-sm bg-gradient-to-b from-white/30 to-white dark:from-zinc-900 dark:to-zinc-900"
          >
                ...
                <div
                  className={`max-w-[85%] px-3 py-2 rounded-2xl whitespace-pre-wrap leading-relaxed ${
                    m.role === "user"
                      ...
                      : "bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 border border-pink-100 dark:border-zinc-700"
                  }`}
                >
                  {m.content}
                </div>
            ...
            {streaming && (
              <div className="flex justify-start">
                <div className="max-w-[85%] px-3 py-2 rounded-2xl whitespace-pre-wrap leading-relaxed bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 border border-pink-100 dark:border-zinc-700">
                  {streaming}
            ...
            {loading && !streaming && (
              <div className="flex justify-start">
                <div className="bg-white dark:bg-zinc-800 px-3 py-2 rounded-2xl text-zinc-500 flex items-center gap-1 border border-pink-100 dark:border-zinc-700">
                  <span
