  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-1 shrink-0 self-stretch px-3 rounded-r-2xl bg-white/60 hover:bg-pink-100 transition active:scale-95 select-none border-l border-pink-200"
        style={{ direction: "ltr" }}
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-pink-100">
                ...
                <button
                  type="button"
                  onClick={() => setOpen(false)}
                  className="w-8 h-8 flex items-center justify-center rounded-full bg-white text-pink-400 hover:bg-pink-100 transition"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="px-4 py-3 border-b border-pink-50">
                <div className="flex items-center gap-2 rounded-2xl border border-pink-200 bg-white/50 px-3 py-2">
                  ...
                  filtered.map((country) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-5 py-3.5 text-right transition active:bg-white ${
                          isSelected
                            ? "bg-white border-r-4 border-pink-500"
