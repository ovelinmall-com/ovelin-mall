    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-pink-100 bg-gradient-to-l from-white to-white">
              ...
              <div className="flex items-center gap-2">
                {(list?.length ?? 0) > 0 && count > 0 && (
                  <button
                    ...
                    className="text-[11px] text-pink-600 font-bold rounded-xl px-2 py-1 hover:bg-white flex items-center gap-1"
                  >
