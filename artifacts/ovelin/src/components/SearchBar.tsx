          ...
          <div className="divide-y divide-gray-100">
            {shown.map((p) => (
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-right hover:bg-white/70 active:bg-pink-100 transition"
              >
                {p.imageUrl ? (
                  <img
                    src={p.imageUrl}
            ...
            {(results?.length ?? 0) > 8 && (
              <button
                ...
                className="w-full px-4 py-3 text-center text-[11px] font-bold text-pink-600 hover:bg-white transition"
              >
