    ...
    <div className="pb-28">
      ...
      >
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-2xl border border-pink-200 bg-pink-50/40 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 text-left"
          dir="ltr"
        />
        ...
        <textarea
          ...
          rows={2}
          className="mt-1.5 w-full rounded-2xl border border-pink-200 bg-pink-50/40 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 resize-none"
        />
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md px-5 pb-5 pt-3 bg-white/90 backdrop-blur-lg border-t border-pink-100 z-50">
        ...
        {user && (
          <div className="text-[11px] text-center text-gray-400 mt-1.5">
            رصيدك: <span className="text-pink-600 font-bold">{formatSDG(user.balance)} ج.س</span>
          </div>
        )}
      </div>
    </div>
