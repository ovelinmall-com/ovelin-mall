...
export const BottomNav = memo(function BottomNav() {
  ...
  // عداد تذاكر الدعم (unreadForUser) — يجب أن يُعرَّف قبل userBadgeTotal
  ...
  // رقم أيقونة APK/PWA للمستخدم العادي (الأدمن يُحسَب داخل useAppIconBadge)
  // نستخدم supportUnread (tickets.unreadForUser) لتتطابق الأيقونة مع ما يُعرَض في شريط التنقل
  const userBadgeTotal = badges.orders + badges.wallet + supportUnread + badges.referrals;
  useAppIconBadge(userBadgeTotal);
  ...
  useEffect(() => {
    ...
    if (location === "/orders" || location.startsWith("/orders/")) {
      ...
      // مسح إشعارات الدعم (notifications table)
      if (badges.support > 0) markSectionRead("support");
      // إعادة جلب عداد التذاكر فوراً (supportTicketsTable.unreadForUser)
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pointer-events-none">
      <div className="w-full max-w-md pointer-events-auto px-3 pb-3">
        <div className="relative">
          ...
          <div className="relative rounded-[28px] bg-white dark:bg-card border border-gray-200/80 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.18)] overflow-visible">
              ...
              <div className="relative flex justify-center">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div className="relative w-16 h-16 rounded-full p-[2.5px] bg-gradient-to-tr from-pink-400 via-pink-500 to-fuchsia-500 shadow-[0_10px_25px_-8px_rgba(236,72,153,0.6)]">
            ...
            >
              ...
              >
                ...
                {support.label}
                {support.badge > 0 && (
                  <span className="min-w-[16px] h-[16px] px-1 rounded-full bg-pink-500 text-white text-[9px] flex items-center justify-center border border-white">
...
const NavItem = memo(function NavItem({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-0.5 active:scale-90 transition-transform duration-100">
        <div
          className={cn(
        ...
        >
          ...
          {item.badge > 0 && (
            <motion.span
              ...
              className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] px-1 rounded-full bg-pink-500 text-white text-[9px] font-extrabold flex items-center justify-center border-2 border-white shadow-sm"
            >
