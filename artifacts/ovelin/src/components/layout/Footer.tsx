    ...
    <footer className="mt-12 px-5 pb-24 pt-10">
      <div className="rounded-3xl bg-gradient-to-br from-pink-600 via-rose-600 to-pink-700 p-6 text-white shadow-[0_20px_60px_-20px_rgba(190,24,93,0.6)]">
        ...
        <p className="text-sm opacity-90 mt-1 leading-relaxed">
          يثق بنا آلاف العملاء يومياً — ولسبب وجيه. آلاف الطلبات المكتملة بنجاح،
          ثقتك هي أهم ما نملك. خدمة موثوقة، تسليم مضمون، ورضاك خطنا الأحمر.
          لا نُقدّم وعوداً فارغة — أرقامنا تتكلم عن نفسها. كل طلب نُنفّذه أمانة
          — وكل عميل راضٍ شهادة نفخر بها.
        </p>
