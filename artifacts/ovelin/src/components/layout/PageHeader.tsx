...
export function PageHeader({
  ...
  return (
    <div className="sticky top-0 z-30 bg-white/95 backdrop-blur-xl border-b border-pink-100/60">
      <div className="relative px-5 pt-4 pb-3.5 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          >
            <div className="p-[2px] rounded-2xl bg-gradient-to-tr from-pink-400 via-rose-500 to-pink-500">
