...
export const PLATFORMS: PlatformInfo[] = [
  ...
  { slug: "free-fire",     platform: "Free Fire",      name: "Free Fire",      emoji: "🔥", hint: "جواهر",            unitName: "جوهرة",  unitNamePlural: "جوهرة",     category: "game_cards",        gradient: "from-orange-600 via-red-700 to-rose-900",      bgImage: "/games/free-fire.webp" },
  ...
  { slug: "mobile-legends",platform: "Mobile Legends", name: "Mobile Legends", emoji: "⚔️", hint: "Diamond",          unitName: "ألماسة", unitNamePlural: "ألماسة",    category: "game_cards",        gradient: "from-blue-700 via-indigo-800 to-violet-900",   bgImage: "/games/mobile-legends.webp" },
  ...
  { slug: "fortnite",      platform: "Fortnite",       name: "Fortnite",       emoji: "🏗️", hint: "V-Bucks",          unitName: "V-Buck", unitNamePlural: "V-Bucks",   category: "game_cards",        gradient: "from-blue-600 via-indigo-700 to-violet-800",   bgImage: "/games/fortnite.webp" },
  { slug: "valorant",      platform: "Valorant",       name: "Valorant",       emoji: "🎯", hint: "VP Points",        unitName: "VP",     unitNamePlural: "VP",        category: "game_cards",        gradient: "from-rose-700 via-red-800 to-zinc-900",        bgImage: "/games/valorant.webp" },
  ...
  { slug: "youtube",   platform: "youtube",    name: "يوتيوب",    emoji: "▶️", hint: "مشاهدات • لايكات",  unitName: "متابع", unitNamePlural: "متابع", category: "social_followers", gradient: "from-red-600 via-rose-700 to-red-900",          bgImage: "/social/youtube.jpg" },
  { slug: "telegram",  platform: "telegram",   name: "تيليغرام",  emoji: "✈️", hint: "متابعين • تعليقات", unitName: "متابع", unitNamePlural: "متابع", category: "social_followers", gradient: "from-sky-500 via-blue-600 to-blue-800",         bgImage: "/social/telegram.jpg" },
];
