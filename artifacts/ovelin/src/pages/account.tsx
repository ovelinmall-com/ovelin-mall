...
export default function Account() {
  ...
  const { data: refData, dataUpdatedAt: refUpdatedAt } = useGetMyReferrals({
    query: {
      ...
      <div className="px-5 space-y-3 pb-4">
        ...
        <div className="fancy-card rounded-3xl p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-[10px] text-muted-foreground">
              {new Date(refUpdatedAt || Date.now()).toLocaleTimeString("ar-EG")}
            </div>
          </div>
                  ...
                  return (
                    <div key={m.month} className="flex-1 flex flex-col items-center gap-1">
                      <motion.div initial={{ height: 0 }} animate={{ height: h }}
                        className="w-full rounded-t-lg bg-gradient-to-t from-pink-500 to-rose-400" title={`${v.toFixed(2)}`} />
        ...
        <div className="fancy-card rounded-3xl p-4">
          ...
          <div className="space-y-2">
            {earnings?.recent.map((c) => (
              <div key={c.id} className="flex items-center justify-between rounded-2xl bg-gradient-to-l from-pink-50/70 to-transparent p-3">
                <div className="flex items-center gap-2 min-w-0">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-pink-400 to-rose-500 text-white font-black uppercase flex items-center justify-center text-sm shrink-0">{c.fromUsername[0]}</div>
        ...
        <div className="fancy-card rounded-3xl p-4">
          ...
          {refData?.referrals?.map((r, i) => (
            <div key={i} className="flex items-center justify-between rounded-2xl bg-pink-50/40 p-3 mb-2 last:mb-0">
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-pink-400 to-rose-500 text-white font-black uppercase flex items-center justify-center text-sm">{r.username[0]}</div>
                <div>
        ...
        <div className="rounded-3xl overflow-hidden shadow-xl border border-pink-100">
          ...
          <div className="relative bg-gradient-to-br from-rose-600 via-pink-600 to-fuchsia-700 px-5 py-4 overflow-hidden">
            ...
            <div className="absolute -bottom-8 -left-4 w-28 h-28 rounded-full bg-fuchsia-400/20 blur-2xl" />
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-3 rounded-2xl px-3 py-2.5 border ${
                    isTop3 ? `bg-gradient-to-r ${rowGradients[i]}` : "bg-pink-50/60 border-pink-100"
                  }`}
                >
                  {/* Rank */}
...
function ActionChip({
  ...
  const inner = (
    <motion.div
      ...
      className={cn(
        "fancy-card relative rounded-2xl p-2.5 text-center transition",
        disabled
          ? "grayscale opacity-45 cursor-not-allowed select-none"
          : "hover:shadow-[0_10px_25px_-8px_rgba(236,72,153,0.5)] cursor-pointer",
      )}
    >
      <div
        className={cn(
