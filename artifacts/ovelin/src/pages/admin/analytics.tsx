...
export default function AdminAnalytics() {
  ...
  const colors = ["bg-pink-500", "bg-pink-500", "bg-rose-500", "bg-pink-500"];
          ...
          <div className="space-y-1.5">
            {data.eventsByType.map((e: any, i: number) => (
              <div key={e.type} className="flex items-center gap-2 text-xs">
                ...
                <div className="flex-1 h-5 bg-pink-50 dark:bg-zinc-800 rounded-full overflow-hidden">
...
function Funnel({ label, v, max }: { label: string; v: number; max: number }) {
  ...
  return (
    <div className="mb-2">
      ...
      <div className="h-3 bg-pink-50 dark:bg-zinc-800 rounded-full overflow-hidden">
