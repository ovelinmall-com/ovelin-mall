      ...
      >
        ...
        {showAdd && (
          <motion.div
            ...
            className="overflow-hidden border-b border-pink-100 bg-white/50"
          >
            <div className="p-4">
        ...
        <div className="grid grid-cols-3 gap-2 px-4 pt-3 pb-2">
          <div className="rounded-xl bg-emerald-50 border border-emerald-200 p-2.5 text-center">
            <div className="flex items-center justify-center gap-1 text-emerald-600 mb-0.5">
              ...
              <span className="text-[10px] font-bold">باقية</span>
            </div>
            <div className="text-xl font-black text-emerald-700">{counts.available}</div>
          </div>
          <div className="rounded-xl bg-pink-50 border border-pink-200 p-2.5 text-center">
            <div className="flex items-center justify-center gap-1 text-pink-600 mb-0.5">
              ...
              <span className="text-[10px] font-bold">مباعة</span>
            </div>
            <div className="text-xl font-black text-pink-700">{counts.sold}</div>
          </div>
          <div className="rounded-xl bg-zinc-50 border border-zinc-200 p-2.5 text-center">
            <div className="flex items-center justify-center gap-1 text-zinc-500 mb-0.5">
              <TrendingUp className="w-3 h-3" />
              <span className="text-[10px] font-bold">الإجمالي</span>
            </div>
            <div className="text-xl font-black text-zinc-700">{counts.all}</div>
          </div>
        </div>

        {msg && (
          <div
            className={`mx-4 mt-1 px-3 py-2 rounded-xl text-xs font-bold flex items-center gap-2 ${
              msg.type === "ok"
          ...
          {filtered.map((c) => (
            ...
            >
              ...
              <button
                ...
                className="p-1.5 rounded-lg bg-zinc-100 text-zinc-500 active:scale-95 hover:bg-zinc-200"
