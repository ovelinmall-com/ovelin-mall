...
export default function AdminSmmServices() {
  ...
  return (
    <div dir="rtl" className="min-h-[100dvh] bg-gradient-to-br from-white via-white to-white">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-pink-200 bg-white/40 px-3 py-2 text-sm focus:outline-none focus:border-pink-500"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full rounded-xl border border-pink-200 bg-white/40 px-3 py-2 text-sm focus:outline-none focus:border-pink-500 resize-none"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-0 rounded-xl border border-pink-300 bg-white/40 px-3 py-2 focus-within:border-pink-500">
                        <input
                          type="text"
                          inputMode="numeric"
                  ...
                  <div className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 flex-wrap mb-0.5">
                          ...
                          {badgeInfo && badgeInfo.id !== "all" && (
                            <span className="text-[9px] bg-white text-pink-700 font-bold px-1.5 py-0.5 rounded-full border border-pink-200 flex items-center gap-0.5">
                      ...
                      <button onClick={() => startEdit(p)}
                        className="p-2 rounded-xl bg-white border border-pink-200 text-pink-700 active:scale-90 hover:bg-pink-100 shrink-0"
                      >
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      ...
                      <div className="rounded-xl bg-white border border-rose-100 p-2 text-center">
        ...
        {showSeedModal && (
          ...
          >
            ...
            >
              ...
              <div className="text-xs text-zinc-600 leading-relaxed bg-white rounded-2xl p-3 border border-pink-100">
