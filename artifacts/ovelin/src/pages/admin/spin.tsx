  ...
  return (
    <div className="min-h-[100dvh] pb-20">
      ...
      <div className="mx-4 bg-white dark:bg-zinc-900 rounded-2xl p-3 mb-3 space-y-2">
        <input value={form.label} onChange={(e) => setForm({ ...form, label: e.target.value })} placeholder="اسم الجائزة" className="w-full px-3 py-2 rounded-lg bg-pink-50 dark:bg-zinc-800 text-sm" />
        <select value={form.type} onChange={(e) => setForm({ ...form, type: e.target.value })} className="w-full px-3 py-2 rounded-lg bg-pink-50 dark:bg-zinc-800 text-sm">
        ...
        <div className="flex gap-2">
          <input value={form.value} onChange={(e) => setForm({ ...form, value: e.target.value })} placeholder="القيمة" className="flex-1 px-3 py-2 rounded-lg bg-pink-50 dark:bg-zinc-800 text-sm" />
          <input value={form.weight} onChange={(e) => setForm({ ...form, weight: e.target.value })} type="number" placeholder="الوزن" className="flex-1 px-3 py-2 rounded-lg bg-pink-50 dark:bg-zinc-800 text-sm" />
        </div>
        {form.type === "coupon" && <input value={form.couponCode} onChange={(e) => setForm({ ...form, couponCode: e.target.value })} placeholder="كود الكوبون" className="w-full px-3 py-2 rounded-lg bg-pink-50 dark:bg-zinc-800 text-sm" />}
