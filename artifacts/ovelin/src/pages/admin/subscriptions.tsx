    ...
    <div className="min-h-[100dvh] pb-24" dir="rtl">
      ...
      <div className="fancy-card sticky top-0 z-20 border-b border-pink-100 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button onClick={() => setLocation("/admin")} className="p-1.5 rounded-full hover:bg-white text-pink-500">
            ...
            {showForm && (
              ...
              >
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-white border border-pink-200 text-sm"
          ...
          {subs.length === 0 ? (
            ...
            <div className="space-y-2.5">
              {subs.map((sub) => (
                ...
                >
                  <div className="bg-gradient-to-l from-white to-white px-3 py-2 flex items-center justify-between border-b border-pink-100">
      ...
      <div className="px-3 py-2.5 flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1.5 flex-wrap">
            <span className="text-[10px] bg-white text-pink-700 rounded-full px-2 py-0.5 font-bold border border-pink-200">
              {formatSDG(plan.price)} ج.س
            </span>
            <span className="text-[10px] bg-white text-rose-700 rounded-full px-2 py-0.5 font-bold border border-rose-200">
        ...
        <div className="flex flex-col items-end gap-1.5 shrink-0">
          ...
          <div className="flex gap-1">
            <button
              onClick={() => onEdit(plan)}
              className="w-7 h-7 rounded-full bg-white border border-pink-200 text-pink-600 flex items-center justify-center active:scale-90"
            >
