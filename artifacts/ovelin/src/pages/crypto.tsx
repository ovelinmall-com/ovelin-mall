      ...
      {!pending && (
        <div className="px-4 space-y-3">
          <div className="fancy-card dark:bg-zinc-900 rounded-2xl p-4 dark:border-pink-900/30">
            ...
            <select value={currency} onChange={(e) => setCurrency(e.target.value)} className="w-full px-3 py-2 rounded-lg bg-white dark:bg-zinc-800">
            ...
            <input value={amount} onChange={(e) => setAmount(e.target.value)} type="number" className="w-full px-3 py-2 rounded-lg bg-white dark:bg-zinc-800" />
      ...
      {pending && (
        <div className="px-4 space-y-3">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl p-4 border border-pink-200 dark:border-pink-900/40">
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-lg p-3 break-all text-xs font-mono">{pending.address}</div>
            ...
            <input value={tx} onChange={(e) => setTx(e.target.value)} placeholder="رقم العملية (TX Hash)" className="w-full mt-3 px-3 py-2 rounded-lg bg-white dark:bg-zinc-800 text-sm" />
