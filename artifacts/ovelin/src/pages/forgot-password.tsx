      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-10">
        ...
        {sent ? (
          ...
          >
            ...
            <p className="text-xs text-pink-500/90 bg-pink-50 rounded-xl px-3 py-2 leading-relaxed">
              في حال لم يصلك البريد، يُرجى التوجه إلى مجلد <span className="font-bold">الرسائل غير المرغوب فيها (Spam)</span>، وستجده هناك.
            </p>
