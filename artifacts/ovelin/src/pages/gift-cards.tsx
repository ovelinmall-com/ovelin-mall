    ...
    <AppLayout>
      ...
      <div className="px-5 space-y-3 pb-4">
        ...
        >
          ...
          <div className="font-extrabold text-lg mb-1">OVELIN MALL</div>
          ...
          <div className="fancy-card rounded-3xl p-4 space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-2xl border border-pink-200 bg-white/40 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400"
                placeholder="10.00"
              />
              <div className="mt-2 grid grid-cols-5 gap-1.5">
                {[5, 10, 25, 50, 100].map((a) => (
                  <button
                    ...
                    className="rounded-xl bg-white text-pink-700 text-xs font-bold py-1.5"
                  >
                    ${a}
                  </button>
                ))}
          ...
          <div className="fancy-card rounded-3xl p-4 space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-2xl border border-pink-200 bg-white/40 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 font-mono tracking-wider"
            ...
            {redeemMsg && (
              <div className={cn(
                ...
                redeemMsg.ok ? "bg-green-50 border-green-200 text-green-700" : "bg-white border-pink-200 text-pink-700"
              )}>
        ...
        <div className="fancy-card rounded-3xl p-4">
          ...
          {list.length === 0 ? (
            ...
            <div className="space-y-2">
              {list.map((c) => (
                <div key={c.id} className="rounded-2xl border border-pink-100 p-3 bg-white/30">
