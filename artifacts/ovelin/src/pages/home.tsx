      ...
      >
        ...
        >
          ...
          <div className="p-5 space-y-4 bg-white">
            ...
            {/* Progress indicator */}
            <div className="rounded-2xl p-3.5 flex items-center gap-3 bg-pink-50 border border-pink-100">
            ...
            <div className="flex justify-center">
              <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-extrabold text-pink-700 bg-pink-50 border border-pink-200">
...
function ServiceCard({
  ...
  const inner = (
    <div className="flex flex-col">
      ...
      <div
        className={`group relative z-10 w-full aspect-[3/4] overflow-hidden rounded-3xl shadow-[0_15px_40px_-12px_rgba(190,24,93,0.55)] ring-1 ring-pink-200/60 bg-gradient-to-br ${gradient} active:scale-[0.96] active:-translate-y-2 transition-transform duration-150`}
      ...
      >
            ...
            {showSocialEmojis ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center" style={{ paddingBottom: "30%" }}>
                <div className="w-[62%] h-[62%] rounded-[22%] overflow-hidden shadow-[0_10px_28px_rgba(0,0,0,0.22)] ring-1 ring-black/5">
                  {/* FIX #13: lazy load all service card images */}
                  <img
                    src={bgImage}
                    alt={name}
        ...
        {/* Pulsing pink stars — CSS-only, 5 stars per card */}
      ...
      <div className="relative z-0 -mt-3 h-[13px] rounded-b-2xl bg-gradient-to-r from-rose-600 via-red-600 to-rose-600 shadow-[0_6px_14px_-2px_rgba(220,38,38,0.55)]" />
      </div>
  );
...
function MoreCard({ href, onClick }: { href?: string; onClick?: () => void }) {
  const inner = (
    ...
    <div className="relative w-full aspect-[3/4] overflow-hidden rounded-3xl bg-gradient-to-br from-pink-50 to-rose-100 border-2 border-dashed border-pink-400 shadow-md flex flex-col items-center justify-center text-pink-700 active:scale-[0.96] transition-transform duration-150">
...
const GRAD_SOCIAL = "from-rose-50 via-pink-100 to-fuchsia-50";
...
function AboutUsCard_DELETED() {
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-2 mt-5">
          {STATS.map((s) => (
            <div
              key={s.label}
              className="flex flex-col items-center bg-white/10 backdrop-blur-sm rounded-2xl py-2.5 px-1 border border-white/15"
            >
      ...
      {/* ── Mission statement ── */}
      <div className="mt-3 rounded-3xl bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-100 p-4">
        ...
        {open && (
          ...
          >
            <div className="mt-2 rounded-3xl overflow-hidden border border-pink-100 shadow-sm">
              ...
              {/* Mission */}
              <div className="bg-pink-50/60 px-5 py-4 border-t border-pink-100">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center text-white">
                    <Sparkles className="w-3 h-3" />
                  </div>
      ...
      <div className="relative bg-gradient-to-l from-pink-700 via-rose-700 to-pink-800 text-white px-5 pt-3 pb-3">
        ...
        <div className="relative flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 active:scale-95 transition">
            ...
            <div className="relative">
              <div className="relative p-[1.5px] rounded-xl bg-gradient-to-tr from-white/90 via-white/30 to-white/90 shadow-[0_0_12px_4px_rgba(255,255,255,0.45)]">
                <img
                  src={`${import.meta.env.BASE_URL}icon-192.png`}
                  alt="Ovelin"
                  className="w-7 h-7 rounded-[10px] object-cover block"
                />
              </div>
            </div>
