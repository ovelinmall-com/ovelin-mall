          ...
          <AnimatePresence mode="wait">
            {tab === "rewards" && (
              ...
              >
                ...
                <div className="fancy-card rounded-3xl p-4">
                  ...
                  <div className="space-y-2">
                    {loyalty.data?.history?.slice(0, 12).map((h) => (
                      <div
                        key={h.id}
                        className="flex items-center justify-between rounded-2xl bg-white/40 p-2.5"
                      >
                ...
                {/* Prime perks */}
                {!prime.data?.active && (
                  <div className="rounded-3xl bg-gradient-to-br from-amber-50 via-white to-white border border-amber-200 p-4">
            ...
            {tab === "draws" && (
              <motion.div
                ...
                className="space-y-3"
              >
                <div className="rounded-2xl bg-white/60 border border-pink-200 p-3 text-xs text-pink-800">
            ...
            {tab === "travel" && (
              <motion.div
                ...
                className="space-y-3"
              >
                <div className="rounded-2xl bg-gradient-to-r from-white to-white border border-pink-200 p-3 text-xs text-pink-800">
      ...
      {editing ? (
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-2xl border border-pink-200 bg-white/40 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400"
            placeholder="100"
          />
          <button
            onClick={() => {
    ...
    <motion.div
      ...
      className={cn(
        ...
        a.unlocked
          ...
          : "bg-white/30 border-pink-100 grayscale",
      )}
    >
      {!a.unlocked && (
