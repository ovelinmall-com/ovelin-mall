      ...
      <div className="px-5 space-y-3 pb-4">
        ...
        {list.length === 0 ? (
          <div className="fancy-card rounded-3xl p-8 text-center">
            <div className="mx-auto w-16 h-16 rounded-full bg-white flex items-center justify-center text-pink-400 mb-3">
              ...
              const Inner = (
                <motion.div
                  className={cn(
                    ...
                    n.read ? "bg-white border-pink-100" : "bg-gradient-to-br from-white to-white border-pink-200",
                  )}
                  onClick={() => !n.read && readOne.mutate(n.id)}
                >
                  <div className={cn(
                    "shrink-0 w-10 h-10 rounded-2xl flex items-center justify-center",
                    n.read ? "bg-white text-pink-400" : "bg-gradient-to-br from-pink-500 to-rose-600 text-white",
                  )}>
