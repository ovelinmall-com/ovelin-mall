    ...
    <AppLayout>
      ...
      <div className="px-5 pb-6 space-y-3">
        ...
        <div className="fancy-card rounded-3xl p-3 flex items-center justify-between">
          ...
          <button
            onClick={refreshAll}
            className="rounded-xl p-1.5 text-pink-600 hover:bg-white"
          >
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                >
                  ...
                  {o.notes && (
                    <div className="text-[11px] text-pink-700 mt-1.5 bg-white/60 rounded-xl px-2 py-1 line-clamp-1">
                      {o.notes}
                    </div>
                  )}
                </button>
                <div className="text-left shrink-0">
                  <div className="text-lg font-extrabold text-pink-600">
                    {formatSDG(o.finalPrice ?? o.price)} ج.س
                  </div>
                  <div
                    className={cn(
              ...
              <div className="mt-3 flex gap-2">
                <button
                  onClick={() => setOpenId(o.id)}
                  className="flex-1 rounded-2xl py-2 text-xs font-bold bg-white text-pink-700 active:scale-95"
                >
                  تفاصيل وتتبّع
                </button>
                <button
    ...
    <AnimatePresence>
      {enabled && (
        ...
        >
          ...
          >
            <div className="px-5 py-4 border-b border-pink-100 bg-gradient-to-l from-white to-white flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-xl hover:bg-white text-pink-700"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
              <div className="rounded-3xl bg-gradient-to-br from-pink-500 to-rose-600 text-white p-4 shadow">
                ...
                <div className="mt-2 flex items-end justify-between">
                  <div>
                    ...
                    <div className="text-2xl font-black">{detail ? formatSDG(detail.finalPrice ?? detail.price) : "—"} ج.س</div>
                  </div>
              ...
              <div className="rounded-2xl bg-white/60 border border-pink-100 p-3 space-y-1.5 text-xs">
                ...
                <div className="space-y-2">
                  {(detail?.events ?? []).map((e) => {
                    ...
                    return (
                      <div
                        key={e.id}
                        className="flex gap-3 items-start rounded-2xl bg-white/40 p-3"
                      >
                  ...
                  {(detail?.events?.length ?? 0) === 0 && (
                    <div className="rounded-2xl bg-white/40 p-3 text-center text-xs text-muted-foreground">
