      ...
      <div className="px-5 space-y-4">
        ...
        <div className="fancy-card rounded-3xl p-4">
          ...
          <textarea
            ...
            rows={3}
            className="mt-1 w-full rounded-2xl border border-pink-200 bg-white/40 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 resize-none"
          />
          ...
          {user && (
            <div className="text-[11px] text-center text-muted-foreground mt-2">
              ...
              <span className="text-pink-600 font-bold">{formatSDG(liveBalance)} ج.س</span>
            </div>
          )}
        </div>
