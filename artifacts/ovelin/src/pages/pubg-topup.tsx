...
import { Zap, ShieldCheck, Crown, Headphones, Send, Wallet } from "lucide-react";
    ...
    <AppLayout>
      <div dir="rtl" className="-mx-0 -my-0">
        ...
        <div className="bg-white px-4 pt-5 pb-10">
          ...
          {/* ── Packages — grid-cols-5 نفس فري فاير بالضبط ── */}
            ...
            {UC_AMOUNTS.map((uc) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`font-black text-[11px] leading-none text-center ${isSelected ? "text-red-600" : "text-gray-800"}`}>
          ...
          {/* ══ مربع الشراء — نفس فري فاير بالضبط ══ */}
          <div className="mt-8 rounded-2xl overflow-hidden border border-red-200"
            ...
            <div className="px-5 py-4 flex items-center justify-between relative overflow-hidden"
              ...
              <div className="text-right relative">
                <div className="text-white/70 text-[10px] font-semibold mb-1 tracking-wide uppercase">الباقة المختارة</div>
                <div className="text-white font-black text-2xl leading-none tabular-nums"
                  style={{ textShadow: "0 2px 8px rgba(0,0,0,0.3)" }}>
                  {selected ? `${selected.toLocaleString("en-US")} UC` : "—"}
                </div>
              </div>
