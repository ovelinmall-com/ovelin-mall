              ...
              <div
                className={cn(
                  ...
                  mine
                    ...
                    : isAi
                      ? "bg-gradient-to-br from-white to-white border border-rose-200 text-rose-900 rounded-tl-md"
      ...
      <div className="sticky bottom-[88px] left-0 right-0 px-3 pb-2">
        <div className="fancy-card rounded-3xl p-2 flex items-end gap-2">
          ...
          <button
            ...
            className="p-3 rounded-2xl bg-white text-pink-600 disabled:opacity-50"
            title="إرفاق ملف"
          >
          ...
          <textarea
            ...
            className="flex-1 resize-none bg-white/40 rounded-2xl px-3 py-2.5 text-sm focus:outline-none disabled:opacity-50 max-h-32"
          />
          <button
            onClick={submit}
            ...
            {csatSent ? (
              ...
              <>
                ...
                <textarea
                  ...
                  className="w-full bg-white rounded-2xl px-3 py-2 text-[13px] focus:outline-none"
                />
                <button
                  onClick={submitCsat}
                  disabled={!csatScore}
