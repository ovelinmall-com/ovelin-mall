          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xl font-extrabold flex items-center gap-2">
                <LifeBuoy className="w-5 h-5" /> راسل فريق OVELIN MALL
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="px-5 -mt-4 space-y-3 pb-6">
        <div className="fancy-card rounded-3xl p-4">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-pink-100 bg-white/40 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400"
          />
          ...
          <textarea
            ...
            className="w-full rounded-2xl border border-pink-100 bg-white/40 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 resize-none"
          />
          ...
          {error && (
            <div className="mt-2 text-[12px] font-bold text-pink-600 bg-white rounded-xl p-2">
              {error}
            </div>
          )}
        ...
        <div className="rounded-3xl bg-gradient-to-br from-white to-white border border-pink-100 p-4 text-[12px] text-pink-900 flex items-start gap-2">
