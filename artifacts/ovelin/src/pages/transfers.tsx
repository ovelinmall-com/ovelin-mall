            ...
            >
              ...
              <div className="fancy-card rounded-3xl p-4 space-y-3">
                ...
                <input
                  ...
                  placeholder="المبلغ ($)"
                  dir="ltr"
                  className="w-full rounded-2xl border border-pink-200 bg-white/40 px-4 py-3 text-sm text-left focus:outline-none focus:ring-2 focus:ring-pink-400"
                />
                <input
                  value={gMessage}
  ...
  return (
    <div
      className={cn(
        ...
        g.status === "redeemed"
          ? "bg-white/30 border-pink-100 opacity-70"
          : "bg-gradient-to-br from-amber-50 to-white border-amber-200",
      )}
    >
      <div className="flex items-center justify-between">
        <div>
          <div className="text-lg font-black text-pink-900">{formatSDG(g.amount)} ج.س</div>
